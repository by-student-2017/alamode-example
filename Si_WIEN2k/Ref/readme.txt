...
12. w2web
13. (Individual mode on Initialize calc.)
...
14. run_lapw -fc 0.02
15. cp 1.scf $CURRENT_DIR/1.scf
16. cd $CURRENT_DIR
17. ./conv_force.sh 1.scf
18. mv XFSET XFSET.harm1
19. cd ..
20. chmod +x run_harm_step2.sh
21. ./run_harm_step2.sh
22. gnuplot < plot_band.gpl